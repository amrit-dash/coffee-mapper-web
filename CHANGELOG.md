...
### Added
- Attendance module
- Lazy loading for improved data presentation performance

### Changed
- Updated system dependencies and SDK configurations
- Improved environment initialization scripts and setups

### Fixed
- Corrected official names and images in the dashboard
- Updated application release URL
